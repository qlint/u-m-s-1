                    ...
                    <form class="form-horizontal form-label-left" novalidate method="post" action="{{URL::route('institute')}}">
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="name" class="form-control col-md-7 col-xs-12" data-validate-length-range="6" name="name" value="{{$institute->name}}" placeholder="Name of Institute" required="required" type="text">
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input id="establish" class="form-control col-md-7 col-xs-12" data-validate-length-range="4" name="establish" value="{{$institute->establish}}" placeholder="Year of Establishment" required="required" type="text">
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="url" id="web" name="web" required="required" placeholder="http://example.com" value="{{$institute->web}}" class="form-control col-md-7 col-xs-12">
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="email" id="email" name="email" required="required" value="{{$institute->email}}" placeholder="example@institute.com" class="form-control col-md-7 col-xs-12">
                      ...
                      <div class="item form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="tel" id="telephone" name="phoneNo" required="required" value="{{$institute->phoneNo}}" placeholder="+254xxxxxxxxx or 0xxxxxxxxx" data-validate-length-range="10,20" class="form-control col-md-7 col-xs-12">
